...
<html>
    ...
    <body>
        ...
        <div id="show-domicilio" class="content scaffold-show" role="main">
            ...
            <f:display bean="domicilio" />
            <g:form resource="${this.domicilio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.domicilio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
